...
import { SiChessdotcom, SiInstagram, SiX, SiYoutube } from "@icons-pack/react-simple-icons";
import { BellIcon, HeartIcon, MailIcon, MapPinIcon, SwordsIcon, UserPlusIcon } from "lucide-react";
          ...
          <CardContent className="text-muted-foreground text-sm/relaxed">
            <p>
              ...
              <a
                ...
                target="_blank"
                className="text-chart-3 dark:text-chart-2 font-medium hover:underline transition-all underline-offset-4"
              >
                Vinkas
              </a>
